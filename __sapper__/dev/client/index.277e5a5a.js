...
// (48:0) <FacebookLogin   clientId="XXX"   state="1"   redirectUri="http://localhost:5000/"   on:success={params => console.log(params)}   on:error={error => console.log(error)}   let:onLogin>
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file, 54, 2, 824);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(48:0) <FacebookLogin   clientId=\\\"XXX\\\"   state=\\\"1\\\"   redirectUri=\\\"http://localhost:5000/\\\"   on:success={params => console.log(params)}   on:error={error => console.log(error)}   let:onLogin>",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 58, 2, 904);
			add_location(figcaption, file, 59, 2, 949);
			attr_dev(figure, "class", "svelte-1azyk8h");
			add_location(figure, file, 57, 0, 893);
			add_location(strong, file, 63, 2, 1013);
			attr_dev(p, "class", "svelte-1azyk8h");
			add_location(p, file, 62, 0, 1007);
		},
		m: function mount(target, anchor) {
