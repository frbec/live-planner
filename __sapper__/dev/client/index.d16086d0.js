...
// (48:0) <FacebookLogin   clientId="400698430951063"   state="1"   redirectUri="http://localhost:3000/"   scope="publish_video"   on:success={params => console.log(params)}   on:error={error => console.log(error)}   let:onLogin>
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file, 55, 2, 860);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(48:0) <FacebookLogin   clientId=\\\"400698430951063\\\"   state=\\\"1\\\"   redirectUri=\\\"http://localhost:3000/\\\"   scope=\\\"publish_video\\\"   on:success={params => console.log(params)}   on:error={error => console.log(error)}   let:onLogin>",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 59, 2, 940);
			add_location(figcaption, file, 60, 2, 985);
			attr_dev(figure, "class", "svelte-1azyk8h");
			add_location(figure, file, 58, 0, 929);
			add_location(strong, file, 64, 2, 1049);
			attr_dev(p, "class", "svelte-1azyk8h");
			add_location(p, file, 63, 0, 1043);
		},
		m: function mount(target, anchor) {
